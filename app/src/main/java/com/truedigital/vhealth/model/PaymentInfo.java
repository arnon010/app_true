...
public class PaymentInfo {
    ...
    public PaymentInfo(int id, String typeCode, String titleName, int resImageDrawable, boolean isChecked, String pricePerMinuteFormat) {
        this.id = id;
    ...
    public PaymentInfo(int id, int resId, int resIdActive, String titleName, boolean isAvailable, boolean isChecked) {
        this.id = id;
        this.resId = resId;
