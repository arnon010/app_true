...
public class ItemDoctorCategory {
    private int id;
    ...
    public ItemDoctorCategory() {
    }

    public ItemDoctorCategory(int id, int categoryId, String description, boolean showIconRemove, boolean showIconAdd) {
        this.id = id;
