...
public class GraphBloodSugarFragment extends BaseMvpFragment<GraphBloodSugarFragmentInterface.Presenter>
        implements GraphBloodSugarFragmentInterface.View {
    ...
    private GraphBloodSugarCriteriaObject criteria;
    private GraphBloodSugarFragment.OnLoadListener onLoadListener;

    public interface OnLoadListener {
        void onLoadComplete();
    }

    public void setOnLoadListener(GraphBloodSugarFragment.OnLoadListener onLoadListener) {
        this.onLoadListener = onLoadListener;
    }

    public GraphBloodSugarFragment() {
        super();
    }

    public static GraphBloodSugarFragment newInstance(GraphBloodSugarCriteriaObject criteria) {
        GraphBloodSugarFragment fragment = new GraphBloodSugarFragment();
    ...
    @Override
    public GraphBloodSugarFragmentInterface.Presenter createPresenter() {
        return GraphBloodSugarFragmentPresenter.create();
    }

    @Override
    public int getLayoutView() {
        return R.layout.fragment_graph_blood_sugar;
    }
    ...
    public void setupView() {
        ...
        imgPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getPresenter().getGraphBloodSugar(criteria);
            }
        });
    ...
    @Override
    public void setGraphBloodSugar(ChartObject chart) {
        this.chart = chart;
    ...
    public void searchGraphBloodSugar() {
        getPresenter().getGraphBloodSugar(criteria);
    }
    ...
    private void setDataChart() {
        ...
        if (chart.getDataList().size() > 0) {
            ...
            for (ChartDataObject data : chart.getDataList()) {
                ...
                lineSet.setHighLightColor(getActivity().getResources().getColor(R.color.color_green));
                lineSet.setColor(getActivity().getResources().getColor(R.color.color_green));
                lineSet.setLineWidth(2.5f);
                lineSet.setCircleColor(getActivity().getResources().getColor(R.color.color_green));
                lineSet.setCircleColorHole(getActivity().getResources().getColor(R.color.color_green));
                lineSet.setCircleRadius(3f);
                lineSet.setFillColor(getActivity().getResources().getColor(R.color.color_green));
                lineSet.setMode(LineDataSet.Mode.CUBIC_BEZIER);
                lineSet.setValueTextSize(10f);
                lineSet.setValueTextColor(getActivity().getResources().getColor(R.color.color_green));
