...
public class ViewArticleItem extends RelativeLayout {

    private TextView tvName;
    private ImageView ivImage;
    private View overlayView;

    public ViewArticleItem(Context context) {
        super(context);
        initInflate();
        initInstances();
    }

    public ViewArticleItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
        initWithAttrs(attrs);
    ...
    public ViewArticleItem(Context context, AttributeSet attrs, int defStyleAttr) {
