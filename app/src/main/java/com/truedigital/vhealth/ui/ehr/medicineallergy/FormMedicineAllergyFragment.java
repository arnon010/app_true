...
public class FormMedicineAllergyFragment extends BaseMvpFragment<FormMedicineAllergyFragmentInterface.Presenter>
        implements FormMedicineAllergyFragmentInterface.View {
    ...
    public FormMedicineAllergyFragment() {
        super();
    }

    public static FormMedicineAllergyFragment newInstance(MedicineAllergyObject data, boolean isNew, boolean isNewFromMenu) {
        FormMedicineAllergyFragment fragment = new FormMedicineAllergyFragment();
        fragment.data = data;
    ...
    @Override
    public FormMedicineAllergyFragmentInterface.Presenter createPresenter() {
        return FormMedicineAllergyFragmentPresenter.create();
    }

    @Override
    public int getLayoutView() {
        return R.layout.fragment_form_medicine_allergy;
    }
    ...
    public void initialize() {
        ...
        if (!this.isNew) {
            ((MainActivity) getActivity()).updateToolbar(getResources().getString(R.string.update_medicine_allergy), false,null, false);

            edtTitle.setText(data.getTitle());
            edtDescription.setText(data.getDetail());
            btnSave.setText(getResources().getString(R.string.update_medicine_allergy));
            btnSave.setOnClickListener(this.onUpdateClickListener());
        } else {
            ((MainActivity) getActivity()).updateToolbar(getResources().getString(R.string.new_medicine_allergy), false,null, false);

            btnSave.setText(getResources().getString(R.string.new_medicine_allergy));
        ...
        data.getAttachmentList().add(new MedicineAllergyImageObject());
        setTempImageList();
    ...
    private void setTempImageList() {
        ...
        ArrayList<MedicineAllergyImageObject> temp = new ArrayList<>();
        for (MedicineAllergyImageObject img : data.getAttachmentList()) {
    ...
    private ListImageAdapter.OnClickListener<MedicineAllergyImageObject> onImageListClickListener() {
        return new ListImageAdapter.OnClickListener<MedicineAllergyImageObject>() {
            @Override
            ...
            @Override
            public void onViewClick(MedicineAllergyImageObject data) {
                if (!data.getIsVideo()) {
            ...
            @Override
            public void onDelete(final MedicineAllergyImageObject img) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent dataIntent) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            MedicineAllergyImageObject imgNew = new MedicineAllergyImageObject();
    ...
    private View.OnClickListener onNewClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                setData();
                getPresenter().newMedicineAllergy(getActivity(), data);
            }
        };
    }
    ...
    private View.OnClickListener onUpdateClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                setData();
                getPresenter().updateMedicineAllergy(getActivity(), data);
            }
        };
    }
    ...
    @Override
    public void onNewSuccess(final MedicineAllergyObject data) {
        SuccessDialog dialog = new SuccessDialog(getActivity());
        dialog.showDialog(getResources().getString(R.string.new_medicine_allergy_success));
        dialog.setOnShowFinishListener(new SuccessDialog.OnShowFinishListener() {
            @Override
            public void onShowFinish() {
                MainActivity main = ((MainActivity) getActivity());
                if (isNewFromMenu) {
                    main.removeToFragment(FormMedicineAllergyFragment.class.toString());
                    main.openMedicineAllergy(data.getPatientId(), data.getPatientMenuId());
                } else {
                    int index = getActivity().getSupportFragmentManager().getBackStackEntryCount() - 2;
                    if (index >= 0) {
                        FragmentManager.BackStackEntry backEntry = getFragmentManager().getBackStackEntryAt(index);
                        String tag = backEntry.getName();
                        MedicineAllergyFragment fragment = (MedicineAllergyFragment) getFragmentManager().findFragmentByTag(tag);
    ...
    @Override
    public void onUpdateSuccess(MedicineAllergyObject data) {
        SuccessDialog dialog = new SuccessDialog(getActivity());
        dialog.showDialog(getResources().getString(R.string.update_medicine_allergy_success));
        dialog.setOnShowFinishListener(new SuccessDialog.OnShowFinishListener() {
            @Override
            public void onShowFinish() {
                int index = getActivity().getSupportFragmentManager().getBackStackEntryCount() - 2;
