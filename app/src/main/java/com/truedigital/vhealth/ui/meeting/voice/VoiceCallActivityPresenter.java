...
public class VoiceCallActivityPresenter extends BaseMvpPresenter<VoiceCallActivityInterface.View>
        implements VoiceCallActivityInterface.Presenter{

    private static final String TAG = "VideoCall";
    private int countCallApi;

    public static VoiceCallActivityInterface.Presenter create() {
        return new VoiceCallActivityPresenter();
    }
            ...
            public void onResponse(Call<ApiTokenTokboxObject> call, Response<ApiTokenTokboxObject> response) {
                if (response.isSuccessful()) {
                    ...
                    if (apiTokenTokboxObject.isSuccess()) {
                        getView().openConnectVoiceCall(apiTokenTokboxObject.getSessionId(),apiTokenTokboxObject.getToken());
                    }
                }
                else {
